...
const attractionInsertButton = document.getElementById("attractionInsertButton");
...
function insertAttraction()
{
    ...
    {
        const existingData = JSON.parse(localStorage.getItem("userAttractions")) || [];
...
{
    const savedAttractions = JSON.parse(localStorage.getItem("userAttractions")) || [];
